...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h2>WORLD BANK</h2></a>
      ...
      <span class="navbar-toggler-icon" style="background:white;"></span>
       ...
       <div class="collapse navbar-collapse text-center" id="collapsenavbar">
          <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                  <a href="index.html" class="nav-link text-white">ABOUT</a></li>
              <li class="nav-item">
                  <a href="viewcustomers.php" class="nav-link text-white">VIEW CUSTOMER</a></li>
              <li class="nav-item">
                  <a href="index.html#contact" class="nav-link text-white">CONTACT</a></li>    
               </ul>
        </div>
     </div>
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:80px;background-color:#7A3DAF;border-radius:10px;color:white" >
              <form method="POST">  
                                              
<?php
include 'connection.php';
$ids=$_GET['idtransfer'];
$showquery="select * from `bank` where id=($ids) ";
...
?> 
                    ...
                    <h3>FROM</h3>
                        ...
                        <label>Email</label>
                        <input type="text" name="email1" value="<?php echo $arrdata['email']; ?>" required placeholder="Enter your email"/><br><br>
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:60px;height:380px;">
                   <div class="card-body">
                   <img src="images/pay.png" style="width:250px;height:220px;">
                   <label>Amount</label>
          ...
          <div class="col-sm-4">
                <div class="card text-center" style="margin-top:80px;background-color:#7A3DAF;border-radius:10px;color:white">
                   ...
                   <h3>TO</h3>
                        ...
                        <label>Email</label>
                        <input type="text" name="email2" value="" required placeholder="Enter your email"/><br><br>
...
if(isset($_POST['submit']))
{
    ...
    $ids=$_GET['idtransfer'];
    $senderquery="select * from `bank` where id=$ids ";
    ...
    //receiverquery
    $receiverquery="select * from `bank` where email='$Receiver_email' ";
    ...
    if($arrdata['amount'] >= $Sender)
    {
      ...
      $increase_receiver=$receiver_arr['amount'] + $Sender;
       $query="UPDATE `bank` SET `id`=$ids,`amount`= $decrease_sender  where `id`=$ids ";
       $rec_query="UPDATE`bank` SET `id`=$id_receiver,`amount`= $increase_receiver where  `id`=$id_receiver ";
